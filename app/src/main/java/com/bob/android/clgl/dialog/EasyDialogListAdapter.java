...
public class EasyDialogListAdapter extends BaseAdapter {
    ...
    public EasyDialogListAdapter(Context context,
                                 List<EasyDialog.ListItem> listItems, int listStyle) {
    ...
    private class ViewHolder {
        ...
        private CheckedTextView mRadioButton;

        public ViewHolder() {
            mConvertView = mInflater.inflate(R.layout.widget_dialog_list_item, null,
                    false);
            mIcon = (ImageView) mConvertView
                    .findViewById(R.id.dialog_list_item_ic);
            mLabel = (TextView) mConvertView
                    .findViewById(R.id.dialog_list_item_cbx_lb);
            mSubLabel = (TextView) mConvertView
                    .findViewById(R.id.dialog_list_item_cbx_sublb);
            mCheckBox = (CheckedTextView) mConvertView
                    .findViewById(R.id.dialog_list_item_cbx);
            mRadioButton = (CheckedTextView) mConvertView
                    .findViewById(R.id.dialog_list_item_rdobtn);
        }

        private void setBackground() {
            if (mListStyle == EasyDialog.LIST_STYLE_GRIDVIEW) {
                // if (mRowTheme == LIGHT_THEME) {
                // mConvertView.setBackgroundResource(R.drawable.dialog_gv_border_light);
                // } else {
                // mConvertView.setBackgroundResource(R.drawable.dialog_gv_border_black);
                // }
                mConvertView.setBackgroundResource(R.drawable.widget_dialog_gv_border);
            } else {
        ...
        private void setTheme(EasyDialog.ListItem item) {
            int textColor;
            if (mRowTheme == LIGHT_THEME) {
                // mCheckBox.setButtonDrawable(R.drawable.dialog_btn_chk);
                // mRadioButton.setButtonDrawable(R.drawable.dialog_btn_rdo);
